...
class FilesEngine {
    ...
    static func detectFileType(at path: String) -> FileType? {
        ...
        let rawType = FilesEngine.detectFileType(cStr)
    ...
    static func scanDirectory(at path: String, recursive: Bool = false) -> [FileInformation]? {
        ...
        var count: Int32 = 0
        guard let cArray = FilesEngine.scanDirectory(cStr, recursive, &count) else {
            return nil
        }
        
        defer { FilesEngine.freeFileInfoArray(cArray) }
    ...
    static func bulkDelete(paths: [String]) -> Int {
        ...
        return Int(FilesEngine.bulkDelete(cPathArray, Int32(cPathArray.count)))
    }
    ...
    static func bulkCopy(sourcePaths: [String], to destDir: String) -> Int {
        ...
        return Int(FilesEngine.bulkCopy(cPathArray, cDestDir, Int32(cPathArray.count)))
    }
    ...
    static func bulkMove(sourcePaths: [String], to destDir: String) -> Int {
        ...
        return Int(FilesEngine.bulkMove(cPathArray, cDestDir, Int32(cPathArray.count)))
    }
    ...
    static func validateArchive(at path: String) -> Bool {
        ...
        return FilesEngine.validateArchive(cStr)
    }
    ...
    static func compareFiles(_ file1: String, _ file2: String) -> (identical: Bool, diffSize: UInt64) {
        ...
        let identical = FilesEngine.compareFiles(cStr1, cStr2, &diffSize)
    ...
    static func checkIntegrity(at path: String, expectedHash: String) -> Bool {
        ...
        return FilesEngine.checkIntegrity(cStr, cHashStr)
    }
    
    /// Get last error message
    static func getLastError() -> String? {
        guard let cError = FilesEngine.getLastError() else { return nil }
