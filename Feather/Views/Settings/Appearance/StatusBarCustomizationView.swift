...
struct StatusBarCustomizationView: View {
    ...
    @State private var selectedPanel: Panel = .preview
        ...
        GeometryReader { geometry in
            if UIDevice.current.userInterfaceIdiom == .pad {
                ...
                HStack(spacing: 0) {
                    ...
                    // Center Panel: Read-only Preview
                    StatusBarPreviewView(viewModel: viewModel)
                        ...
                        Button {
                            ...
                            VStack(spacing: 4) {
                                ...
                                Text("Preview")
                                    .font(.caption)
                                Rectangle()
                                    .fill(selectedPanel == .preview ? Color.accentColor : Color.clear)
                                    .frame(height: 2)
                            }
                            .frame(maxWidth: .infinity)
                        }
